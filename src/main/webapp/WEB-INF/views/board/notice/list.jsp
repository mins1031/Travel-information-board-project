  ...
  <div class="container">
          ...
          <div>
            <div>
			  <sec:authorize access="hasRole('ROLE_ADMIN')">	     
                   <input type="button"  class="btn btn-primary" id="noticeRegister" style='float:right;' value="공지사항 등록">
			  </sec:authorize>
      ...
      <table class="table table-striped table-bordered table-hover">
       ...
       <c:forEach items="${noticeList}" var="notice">
         <tr>
           <td><c:out value="${notice.n_id}" /></td>
           <td><a class='move' href='<c:out value="${notice.n_id}"/>'>
           <c:out value="${notice.n_title}" /></a></td>
           <td><c:out value="${notice.user.u_id}"/></td>
           <td><fmt:formatDate pattern="yyyy-MM-dd" value="${notice.n_regdate}"/></td>
         </tr>
       </c:forEach>
     </table>    
     <!-- 글목록 끝 -->
